...
const UserDMain = () => {
    ...
    if (!stats) return <div className='text-center text-gray-500'>No stats available.</div>;
    ...
    return (
        <div className='p-6'>
            <div>
                ...
                <p className='text-gray-500'>Hi, {user?.username || 'User'}! Welcome to your user dashboard.</p>
            </div>
